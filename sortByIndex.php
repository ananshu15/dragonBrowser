...
include "connect.php";
  ...
  // to determine which page number you are on
    ...
    $sql='SELECT * FROM dragon ORDER BY id ASC LIMIT ' . $pageResult . ',' .  $displayPerPage;
    $output = mysqli_query($conn, $sql);
    ...
    <div class="container-fluid">
     ...
     <nav>
            <ul class="pagination justify-content-center">
                <?php
                //First Page
                echo "<li class='page-item'><center><a href='sortByIndex.php?page=1' ><button>First</button></a></li>";
                ?>

                <?php
                //Previous page
                    if ($totalPage > 1) {
                        echo "<li><a href='sortByIndex.php?page=".($totalPage-1)."' ><button>Previous</button></a></li>";
                    }
                    else {
                ...
                <?php
                    ...
                    if ($totalPage < $noOfPages) {
                        echo "<li><a href='sortByIndex.php?page=".($totalPage+1)."'><button>Next</button></a></li>";
                    }
                    else {
                ...
                <?php
                //Last Page
                echo "<li><a href='sortByIndex.php?page=".$noOfPages."'><button>Last</button></a></li>";
                ?>
            </ul>
        </nav>
    </div>
